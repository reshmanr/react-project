...
const Travel = () => {
  ...
  const travelPosts = allPosts?.filter((post: Post) => post.category === 'travel');
  ...
  if (isLoading) return <p>Loading Travel Posts...</p>;
  if (error) return <p>Error loading Travel Posts: {error.message}</p>;

  return (
    <div className="max-w-4xl mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">Travel Posts</h1>
